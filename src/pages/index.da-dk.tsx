...
import Page from "../components/page/danish_page";
...
const IndexPage = () => {
  const data = useStaticQuery(graphql`
    query {
      header: prismicHomePage(lang: { eq: "da-dk" }) {
        data {
          header_subtitle
          header_title_one
          header_title_two
      ...
      benefits: prismicHomePage(lang: { eq: "da-dk" }) {
        data {
          benefits_subtitle
      ...
      getStarted: prismicHomePage(lang: { eq: "da-dk" }) {
        data {
          get_started_title
          try_it_button_text
